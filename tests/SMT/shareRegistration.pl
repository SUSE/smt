...
my $regInfo = "<?xml version='1.0' encoding='UTF-8'?>"
    ...
    . "<entry columnName='NAMESPACE' value=''/>"
    . "<entry columnName='HOSTNAME' value='smt-client'/>"
    . "<entry columnName='TARGET' value='sle-11-x86_64'/>"
    . "<entry columnName='GUID' value='03a8f41f176d4776aed0ea2263ea82c4'/>"
    . "<entry columnName='SECRET' value='efaf1ed2f80a4548b4904dc5888f9958'/>"
    . "<entry columnName='DESCRIPTION' value=''/>"
    . "<entry columnName='REGTYPE' value='SR'/>"
    . "<entry columnName='LASTCONTACT' value='2014-08-27 13:41:11'/>"
    . "</tableData>"
    . "<tableData table='Registration'>"
    . "<entry columnName='REGDATE' value='2014-08-26 09:58:15'/>"
    . "<entry columnName='NCCREGERROR' value='0'/>"
    . "<entry columnName='NCCREGDATE' value='2014-08-26 09:58:15'/>"
    . "<entry columnName='GUID' value='03a8f41f176d4776aed0ea2263ea82c4'/>"
    . "<entry columnName='PRODUCTID' value='100550'/>"
    . "</tableData>"
    . "</registrationData>";
