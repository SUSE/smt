package Log::Dispatch::Email::SMT;
...
sub new
{
  ...
  my %p = @_;
  # 'to' is defined in smt.conf. We do not need it here.
  # we set a dummy because 'to' is required.
  $p{to} = 'root@localhost';
...
sub send_email
{
    ...
    SMT::Utils::sendMailToAdmins($self->{subject}, $p{message});
}
